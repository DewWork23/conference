...
export default function NetworkingPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-[#041E42] mb-2">Networking</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="w-12 h-12 bg-[#041E42] rounded-lg flex items-center justify-center mb-4">
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          </div>
          <h3 className="text-lg font-bold text-[#041E42] mb-2">Attendee Directory</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="w-12 h-12 bg-[#FDB913] rounded-lg flex items-center justify-center mb-4">
            <svg className="w-6 h-6 text-[#041E42]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
          </div>
          <h3 className="text-lg font-bold text-[#041E42] mb-2">Networking Events</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <h3 className="text-lg font-bold text-[#041E42] mb-2">Interest Groups</h3>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#041E42] focus:border-transparent"
              />
        ...
        {filteredParticipants.map(participant => (
          <div key={participant.id} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <div className="flex items-start mb-4">
              <div className={`w-16 h-16 ${participant.type === 'presenter' ? 'bg-[#FDB913]' : 'bg-[#041E42]'} rounded-full flex items-center justify-center text-white text-xl font-bold flex-shrink-0`}>
                {participant.name.split(' ').map(n => n[0]).join('')}
              </div>
              <div className="ml-4 flex-1">
                <h3 className="font-bold text-[#041E42] text-lg mb-1">{participant.name}</h3>
            ...
            <button className="w-full px-4 py-2 bg-[#041E42] text-white rounded-md hover:bg-[#0A2F5F] transition-colors text-sm font-medium">
              Connect
            </button>
          </div>
        ))}
      ...
      <div className="mt-12 bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-[#041E42] mb-6">Interest Groups</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div key={group.name} className="border border-gray-200 rounded-lg p-4 hover:border-[#FDB913] transition-colors cursor-pointer">
              <h3 className="font-bold text-[#041E42] mb-2">{group.name}</h3>
              <div className="flex items-center justify-between">
                <span className={`text-xs px-3 py-1 rounded-full ${group.color}`}>
                  {group.members} members
                </span>
                <button className="text-sm text-[#041E42] hover:underline font-medium">
                  Join
                </button>
              </div>
            </div>
      ...
      {/* Networking Tips */}
      <div className="mt-8 bg-gradient-to-r from-[#041E42] to-[#0A2F5F] text-white rounded-lg p-6">
