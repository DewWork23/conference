        ...
        <FavoritesProvider>
          ...
          <footer className="bg-white py-8 mt-12 border-t-4 border-[#947843]">
            <div className="container mx-auto px-4 text-center">
              <p className="text-sm text-black">© 2026 UNC Pembroke | Southeastern Social Work Conference</p>
              <p className="text-xs mt-2 text-gray-600">Demo prototype - no data persistence</p>
            </div>
          </footer>
        </FavoritesProvider>
      </body>
