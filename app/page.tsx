...
export default function Home() {
  return (
    <div className="container mx-auto px-4 py-12">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#041E42] to-[#0A2F5F] text-white rounded-lg p-12 mb-12 shadow-xl">
        <div className="max-w-4xl">
          ...
          <Link
            href="/schedule"
            className="inline-block bg-[#FDB913] text-[#041E42] px-8 py-3 rounded-lg font-bold text-lg hover:bg-[#f5c842] transition-colors"
          >
            View Schedule
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        <div className="bg-white p-6 rounded-lg shadow-md text-center border-t-4 border-[#041E42]">
          <div className="text-4xl font-bold text-[#041E42] mb-2">30</div>
          <div className="text-gray-600">Sessions</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md text-center border-t-4 border-[#FDB913]">
          <div className="text-4xl font-bold text-[#041E42] mb-2">20</div>
          <div className="text-gray-600">Expert Presenters</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md text-center border-t-4 border-[#041E42]">
          <div className="text-4xl font-bold text-[#041E42] mb-2">6</div>
          <div className="text-gray-600">Topic Tracks</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md text-center border-t-4 border-[#FDB913]">
          <div className="text-4xl font-bold text-[#041E42] mb-2">37.5</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Link href="/schedule" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-xl font-bold mb-2 text-[#041E42]">Conference Schedule</h2>
        ...
        <Link href="/presenter" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-xl font-bold mb-2 text-[#041E42]">Presenter Portal</h2>
        ...
        <Link href="/evaluations" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-xl font-bold mb-2 text-[#041E42]">Session Evaluations</h2>
        ...
        <Link href="/announcements" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-xl font-bold mb-2 text-[#041E42]">Announcements</h2>
        ...
        <Link href="/ceu" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-xl font-bold mb-2 text-[#041E42]">CEU Tracking</h2>
        ...
        <Link href="/networking" className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-xl font-bold mb-2 text-[#041E42]">Networking</h2>
      ...
      <div className="mt-12 bg-white p-8 rounded-lg shadow-md">
        <h2 className="text-3xl font-bold mb-6 text-[#041E42]">Conference Topics</h2>
